...
<div id="buddypress">
	...
	<form action="" method="post" id="groups-directory-form" class="dir-form">
		...
		/**
		 * Contained the '.item-list-tabs' inside of the '.row'.
		 *
		 * Updated By: Jasper
		 *
		 * @since 1.0
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="item-list-tabs group-type">
					<ul>
						<li class="selected" id="groups-all"><a href="<?php bp_groups_directory_permalink(); ?>"><?php printf( esc_html__( 'All Committees %s', 'flocks' ), '<span>' . bp_get_total_group_count() . '</span>' ); ?></a></li>

						<?php if ( is_user_logged_in() && bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ) : ?>
							<li id="groups-personal"><a href="<?php echo bp_loggedin_user_domain() . bp_get_groups_slug() . '/my-groups/'; ?>"><?php printf( esc_html__( 'My Committees %s', 'flocks' ), '<span>' . bp_get_total_group_count_for_user( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
						<?php endif; ?>

						<?php

						/**
					 	 * Comment out bp_groups_directory_group_filter() and used
						 * this function in the groups-loop.php file.
						 *
						 * Updated By: Jasper
						 *
