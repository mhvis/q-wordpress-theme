...
<div class="main-column">
	...
	<?php if ( bp_group_has_invites( bp_ajax_querystring( 'invite' ) . '&per_page=10' ) ) : ?>
		...
		<ul id="friend-list" class="item-list item-list bp-objects-loop members-grid type-grid">
		...
		<?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
			...
			<li id="<?php bp_group_invite_item_id(); ?>">
				...
				<div class="action mg-top-20">
					<a class="button remove" href="<?php bp_group_invite_user_remove_invite_url(); ?>" id="<?php bp_group_invite_item_id(); ?>"><?php esc_html_e( 'Remove Invite', 'flocks' ); ?></a>
	...
	<?php else : ?>
		...
		<div id="message" class="info">
			<p><?php esc_html_e( 'Select friends to invite.', 'flocks' ); ?></p>
		</div>
