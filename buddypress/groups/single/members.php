...
<?php if ( bp_group_has_members( bp_ajax_querystring( 'group_members' ) ) ) : ?>
	...
	<ul id="member-list" class="item-list bp-objects-loop members-grid type-grid">
			...
			<li>
				<div class="item-avatar">
					<a href="<?php bp_group_member_domain(); ?>">
						<?php bp_group_member_avatar_thumb('type=full&width=130&height=130'); ?>
					</a>
				</div>
				<div class="item-link">
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php esc_html_e( 'No members were found.', 'flocks' ); ?></p>
	</div>
