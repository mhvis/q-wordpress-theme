...
<h2 class="bp-screen-reader-text"><?php esc_html_e( 'Manage Group Details', 'flocks' ); ?></h2>
...
<label for="group-name"><?php esc_html_e( 'Group Name (required)', 'flocks' ); ?></label>
<input type="text" name="group-name" id="group-name" value="<?php bp_group_name(); ?>" aria-required="true" />

<label for="group-desc"><?php esc_html_e( 'Group Description (required)', 'flocks' ); ?></label>
...
<p>
	<label for="group-notify-members">
		<input type="checkbox" name="group-notify-members" id="group-notify-members" value="1" /> <?php esc_html_e( 'Notify group members of these changes via email', 'flocks' ); ?>
	</label>
</p>
