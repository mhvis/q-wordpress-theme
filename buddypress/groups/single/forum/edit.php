...
<?php if ( bp_has_forum_topic_posts() ) : ?>
	...
	<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
		...
		<div class="item-list-tabs" id="subnav">
			<ul>
				<li>
					<a href="#post-topic-reply"><?php esc_html_e( 'Reply', 'flocks' ); ?></a>
				</li>
		...
		<div id="topic-meta">
			<h3><?php esc_html_e( 'Edit:', 'flocks' ); ?> <?php bp_the_topic_title(); ?> (<?php bp_the_topic_total_post_count(); ?>)</h3>
		...
		<?php if ( bp_is_edit_topic() ) : ?>
			...
			<div id="edit-topic">
				...
				<p class="submit"><input type="submit" name="save_changes" id="save_changes" value="<?php esc_attr_e( 'Save Changes', 'flocks' ); ?>" /></p>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php esc_html_e( 'This topic does not exist.', 'flocks' ); ?></p>
	</div>
