...
<?php if ( bp_group_has_membership_requests( bp_ajax_querystring( 'membership_requests' ) ) ) : ?>
		...
		<?php while ( bp_group_membership_requests() ) : bp_group_the_membership_request(); ?>
			...
			<li class="item-list group-request-list">
				...
				<div class="action">
					...
					'link_title' => esc_attr__( 'Accept', 'flocks' ), 'link_text' => esc_attr__( 'Accept', 'flocks' ) ) ); ?>
					...
					'link_title' => esc_attr__( 'Reject', 'flocks' ), 'link_text' => esc_attr__( 'Reject', 'flocks' ) ) ); ?>
	...
	<?php else: ?>
		...
		<div id="message" class="info">
			<p><?php esc_html_e( 'There are no pending membership requests.', 'flocks' ); ?></p>
		</div>
