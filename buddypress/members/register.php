	...
	<div class="page" id="register-page">
		...
		<?php if ( 'registration-disabled' == bp_get_current_signup_step() ) : ?>
			...
			do_action( 'bp_before_registration_disabled' ); ?>
				...
				<p><?php esc_html_e( 'User registration is currently not allowed.', 'flocks' ); ?></p>
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<div id="flocks-register-heading">
				<h4>
					<?php esc_html_e('Register', 'flocks'); ?>
				</h4>
				<p>
				<?php esc_html_e( 'Joining our community is easy. Just fill in the fields below, and we\'ll get a new account set up for you in no time. You might also need to verify your email address after submitting the form below.', 'flocks' ); ?>
				</p>
			</div>
			<?php
			...
			<div class="register-section" id="basic-details-section">
				...
				<h4><?php esc_html_e( 'Account Details', 'flocks' ); ?></h4>

				<!-- User Name -->
				<div class="row flocks-bp-register-field" id="flocks-bp-register-username">
					<div class="col-md-3">
						<label for="signup_username"><?php esc_html_e( 'Username', 'flocks' ); ?> * </label>
					</div>
					<div class="col-md-9">
				...
				<!-- Email Address -->
				<div class="row flocks-bp-register-field" id="flocks-bp-register-email">
					
					<div class="col-md-3">
						<label for="signup_email"><?php esc_html_e( 'Email Address', 'flocks' ); ?> * </label>
					</div>
				...
				<!--  Password -->
				<div class="row flocks-bp-register-field" id="flocks-bp-register-password">
					<div class="col-md-3">
						<label for="signup_password">
							<?php esc_html_e( 'Choose a Password', 'flocks' ); ?> *
						</label>
					</div>
					<div class="col-md-9">
				...
				<!-- Repeat Password -->
				<div class="row flocks-bp-register-field" id="flocks-bp-register-confirm-password">
					<div class="col-md-3">
						<label for="signup_password_confirm">
							<?php esc_html_e( 'Confirm Password', 'flocks' ); ?> *
						</label>
					</div>
					<div class="col-md-9">
			...
			<?php if ( bp_is_active( 'xprofile' ) ) : ?>
				...
				<div class="register-section" id="profile-details-section">
					...
					<h4><?php esc_html_e( 'Profile Details', 'flocks' ); ?></h4>
						...
						<div<?php bp_field_css_class( 'editfield' ); ?>>
							...
							if ( bp_current_user_can( 'bp_xprofile_change_field_visibility' ) ) : ?>
								<p class="field-visibility-settings-toggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
									<?php
									printf(
										esc_html__( 'This field can be seen by: %s', 'flocks' ),
										'<span class="current-visibility-level">' . bp_get_the_profile_field_visibility_level_label() . '</span>'
									);
									?>
									<a href="#" class="visibility-toggle-link"><?php _ex( 'Change', 'Change profile field visibility level', 'flocks' ); ?></a>
								</p>

								<div class="field-visibility-settings" id="field-visibility-settings-<?php bp_the_profile_field_id() ?>">
									<fieldset>
										<legend><?php esc_html_e( 'Who can see this field?', 'flocks' ) ?></legend>

										<?php bp_profile_visibility_radio_buttons() ?>

									</fieldset>
									<a class="field-visibility-settings-close" href="#"><?php esc_html_e( 'Close', 'flocks' ) ?></a>
			...
			<?php if ( bp_get_blog_signup_allowed() ) : ?>
				...
				<div class="register-section" id="blog-details-section">
					...
					<h4><?php esc_html_e( 'Blog Details', 'flocks' ); ?></h4>

					<p><label for="signup_with_blog"><input type="checkbox" name="signup_with_blog" id="signup_with_blog" value="1"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?> checked="checked"<?php endif; ?> /> <?php esc_html_e( 'Yes, I\'d like to create a new site', 'flocks' ); ?></label></p>

					<div id="blog-details"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?>class="show"<?php endif; ?>>

						<label for="signup_blog_url"><?php esc_html_e( 'Blog URL', 'flocks' ); ?> <?php esc_html_e( '(required)', 'flocks' ); ?></label>
						<?php
						...
						<label for="signup_blog_title"><?php esc_html_e( 'Site Title', 'flocks' ); ?> <?php esc_html_e( '(required)', 'flocks' ); ?></label>
						<?php
						...
						<span class="label"><?php esc_html_e( 'I would like my site to appear in search engines, and in public listings around this network.', 'flocks' ); ?></span>
						<?php
						...
						<label for="signup_blog_privacy_public"><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_public" value="public"<?php if ( 'public' == bp_get_signup_blog_privacy_value() || !bp_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php esc_html_e( 'Yes', 'flocks' ); ?></label>
						<label for="signup_blog_privacy_private"><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_private" value="private"<?php if ( 'private' == bp_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php esc_html_e( 'No', 'flocks' ); ?></label>
			...
			<div class="submit">
				<input type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'flocks' ); ?>" />
			</div>
		...
		<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
			...
			<?php if ( bp_registration_needs_activation() ) : ?>
				<p><?php esc_html_e( 'You have successfully created your account! To begin using this site you will need to activate your account via the email we have just sent to your address.', 'flocks' ); ?></p>
			<?php else : ?>
				<p><?php esc_html_e( 'You have successfully created your account! Please log in using the username and password you have just created.', 'flocks' ); ?></p>
			<?php endif; ?>
